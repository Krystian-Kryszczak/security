...
class AccountServiceImpl(
    ...
    override fun generateChangeUserPasswordCode(id: UUID, oldPassword: String): Single<Boolean> {
     ...
     */
    override fun changeUserPasswordIfArgsMatchesAndAreValid(id: UUID, resetPasswordCode: String, newPassword: String): Single<Boolean> {
